...
const i18n = {
  fr: {
    ...
    heroBadge: "Mr Chris - Barbershop à Bruxelles",
    heroTitle: "Ton style commence ici.",
    heroSubtitle: "Salon masculin situé à la Rue de la Montagne 29, au coeur de Bruxelles. Dégradé moderne, coupe classique, barbe ou rasage traditionnel: un service précis, dans une ambiance humaine.",
    ...
    aboutLabel: "À propos",
    aboutTitle: "Une vision personnelle du barbering masculin",
    aboutP1: "Je m'appelle Chris, coiffeur-barbier spécialisé dans l'univers masculin. Après plus de dix années d'apprentissage et d'expérience, j'ai créé un salon pensé par moi, pour offrir un résultat unique qui te ressemble.",
    aboutP2: "Mon engagement est simple: écouter, comprendre et révéler la personnalité de chaque client. Ici, chaque détail est construit avec passion, exigence et respect du style de chacun.",
    ...
    aboutSkill4: "Adaptation à chaque visage",
    aboutSkill5: "Mèches / coloration naturelle",
    ...
    galleryIntro: "Avant / après, finitions et transformations: une galerie pensée pour montrer la précision du résultat.",
  ...
  nl: {
    ...
    heroBadge: "Mr Chris - Barbershop in Brussel",
    heroTitle: "Jouw stijl begint hier.",
    heroSubtitle: "Herenkapsalon aan Rue de la Montagne 29, in het hart van Brussel. Moderne fade, klassieke snit, baard of traditionele scheerbeurt: precies werk in een warme sfeer.",
    ...
    aboutLabel: "Over",
    aboutTitle: "Een persoonlijke visie op mannenverzorging",
    aboutP1: "Ik ben Chris, kapper-barbier gespecialiseerd in de mannenwereld. Na meer dan tien jaar opleiding en ervaring heb ik mijn eigen salon geopend, met één doel: een resultaat dat echt bij jou past.",
    aboutP2: "Mijn engagement is eenvoudig: luisteren, begrijpen en de persoonlijkheid van elke klant versterken. Elk detail is gebouwd op passie, discipline en respect voor stijl.",
    ...
    aboutSkill4: "Aangepast aan elk gezicht",
    aboutSkill5: "Highlights / natuurlijke kleuring",
    ...
    galleryIntro: "Voor / na, afwerking en transformaties: een galerij die de precisie van het resultaat toont.",
  ...
  en: {
    ...
    heroBadge: "Mr Chris - Barbershop in Brussels",
    heroTitle: "Your style starts here.",
    heroSubtitle: "Men's barbershop at Rue de la Montagne 29, in the heart of Brussels. Modern fade, classic cut, beard shaping or traditional shave: precise service in a warm atmosphere.",
    ...
    aboutLabel: "About",
    aboutTitle: "A personal vision of men's barbering",
    aboutP1: "I'm Chris, a barber specialized in men's grooming. After more than ten years of training and experience, I opened my own salon to deliver one goal: a result that truly fits you.",
    aboutP2: "My commitment is simple: listen, understand and enhance each client's personality. Every detail here is built with passion, discipline and respect for personal style.",
    ...
    aboutSkill4: "Adapted to every face",
    aboutSkill5: "Highlights / natural coloring",
    ...
    galleryIntro: "Before / after, finishing and transformations: a gallery designed to show precision.",
    videoTitle1: "Style clip #01",
